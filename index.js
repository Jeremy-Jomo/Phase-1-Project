...
if (data.weather[0].main === "Clear") {
    ...
    quotes.innerHTML = `<p>Blue skies? Don't get used to it.</p>`;

} else if (data.weather[0].main === "Clouds") {
    weatherIcon.src = "./images/clouds.png";
    quotes.innerHTML = `<p>Guess the sun called in sick again🤷🏻🤷🏻</p>`;
} else if (data.weather[0].main === "Rain") {
    weatherIcon.src = "./images/rain.png";
    quotes.innerHTML = `<p>Not the vibe,but we move.'</p>`;
    ...
    quotes.innerHTML = `<p>Clous said we keep it ✨mid✨ today.</p>`;
}
